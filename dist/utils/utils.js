...
exports.generateRandomSequenceObject = exports.sendEmail = exports.saveFile = void 0;
...
const sendEmail = async (data, email, templateId) => {
    try {
...
const generateRandomSequenceObject = (length = 5) => {
    const sequence = {};
...
exports.generateRandomSequenceObject = generateRandomSequenceObject;
